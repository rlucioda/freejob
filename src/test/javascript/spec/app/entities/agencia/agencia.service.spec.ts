...
describe('Service Tests', () => {
  describe('Agencia Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Agencia(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should update a Agencia', () => {
        const returnedFromService = Object.assign(
          {
            nomeAgencia: 'BBBBBB',
            contatoAgencia: 'BBBBBB',
            email: 'BBBBBB'
          },
          elemDefault
        );
      ...
      it('should return a list of Agencia', () => {
        const returnedFromService = Object.assign(
          {
            nomeAgencia: 'BBBBBB',
            contatoAgencia: 'BBBBBB',
