...
import io.freejob.config.audit.AuditEventConverter;
import io.freejob.domain.PersistentAuditEvent;
...
import static io.freejob.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
