...
export class LocalComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.localService
      ...
      .subscribe((res: HttpResponse<ILocal[]>) => this.paginateLocals(res.body, res.headers));
  }
  ...
  registerChangeInLocals() {
    this.eventSubscriber = this.eventManager.subscribe('localListModification', () => this.loadAll());
  }
  ...
  protected paginateLocals(data: ILocal[], headers: HttpHeaders) {
